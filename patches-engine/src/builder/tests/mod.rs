//! Unit tests for the builder module. Split by category from the original
//! 712-line `tests.rs` per ticket 0537. Shared fixtures and harness
//! helpers live here; behaviour-specific tests live in sibling submodules.
