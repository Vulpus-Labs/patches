...
// Generated by `npm run build` (esbuild) from assets/src/. Regenerate
// after editing any src/*.js file. Committed so cargo builds without
// a Node toolchain.
const SHELL_JS: &str = include_str!("../assets/app.bundle.js");
